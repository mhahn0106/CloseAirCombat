...
register(
    ...
    entry_point='envs.gym_compete.new_envs:MultiAgentEnv',
...
register(
    ...
    entry_point='envs.gym_compete.new_envs:HumansBlockingEnv',
...
register(
    id='sumo-humans-v0',
    entry_point='envs.gym_compete.new_envs:SumoEnv',
...
register(
    ...
    entry_point='envs.gym_compete.new_envs:KickAndDefend',
